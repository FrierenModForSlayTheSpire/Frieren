...
public class LimitBreakMod extends AbstractCardModifier {
    public static final String ID = ModInformation.makeID(LimitBreakMod.class.getSimpleName());

    public static final String[] TEXT = (CardCrawlGame.languagePack.getUIString(ID)).TEXT;


    public LimitBreakMod() {
    }

    public AbstractCardModifier makeCopy() {
        return new LimitBreakMod();
    }
