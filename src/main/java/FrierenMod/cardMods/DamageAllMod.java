...
public class DamageAllMod extends AbstractCardModifier {
    public static final String ID = ModHelper.makePath(DamageAllMod.class.getSimpleName());
    ...
    public void onInitialApplication(AbstractCard card) {
        ...
        if (card instanceof CustomLegendMagic)
            ((CustomLegendMagic)card).loadCardImage("FrierenModResources/img/cards/Strike.png");
    }
