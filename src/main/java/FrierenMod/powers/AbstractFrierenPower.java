...
public abstract class AbstractFrierenPower extends AbstractPower {
    public String[] descriptions;
    public AbstractFrierenPower(String id, AbstractCreature owner, int amount, PowerType type){
        super();
        this.ID = id;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractFrierenPower(String id, AbstractCreature owner, PowerType type){
        super();
        this.ID = id;
        this.owner = owner;
        this.amount = -1;
