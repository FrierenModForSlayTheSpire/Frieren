...
public class Simmering extends AbstractEnemySpell {
    ...
    public Simmering(AbstractCreature owner) {
        super(owner);
    }

    @Override
    public void update() {
        this.addToBot(new ApplyPowerAction(owner, owner, new ThornsPower(owner, POWER_GAIN)));
    }
