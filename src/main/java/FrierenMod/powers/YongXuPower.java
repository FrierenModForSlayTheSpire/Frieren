...
public class YongXuPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = ModHelper.makePath(YongXuPower.class.getSimpleName());
    // 能力的本地化字段
    ...
    public YongXuPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
