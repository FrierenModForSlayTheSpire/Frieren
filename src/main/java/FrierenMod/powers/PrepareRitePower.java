...
public class PrepareRitePower extends AbstractFrierenPower {
    public static final String POWER_ID = ModInformation.makeID(PrepareRitePower.class.getSimpleName());
