...
public class FusionRaid extends AbstractBaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        boolean triggered2 = CombatHelper.triggerRaid(2, true, () -> this.addToBot(new DamageAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.SLASH_DIAGONAL)));
