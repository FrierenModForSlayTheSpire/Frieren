...
public class ReverseFlow extends AbstractFrierenCard {
    public static final String ID = ModInfo.makeID(ReverseFlow.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "FrierenModResources/img/cards/ReverseFlow_skill.png";
