...
public class QiPianMoZuDeXiaoBaXi extends AbstractFrierenCard {
    public static final String ID = ModHelper.makePath(QiPianMoZuDeXiaoBaXi.class.getSimpleName());
