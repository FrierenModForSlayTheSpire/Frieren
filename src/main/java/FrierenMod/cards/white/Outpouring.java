...
public class Outpouring extends AbstractFrierenCard {
    public static final String ID = ModInfo.makeID(Outpouring.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "FrierenModResources/img/cards/Outpouring_skill.png";
