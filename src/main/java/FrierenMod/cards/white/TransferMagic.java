...
public class TransferMagic extends AbstractFrierenCard {
    public static final String ID = ModHelper.makePath(TransferMagic.class.getSimpleName());
