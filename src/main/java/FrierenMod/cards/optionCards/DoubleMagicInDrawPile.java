...
public class DoubleMagicInDrawPile extends AbstractFrierenCard {
    public static final String ID = ModInfo.makeID(DoubleMagicInDrawPile.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String NAME = CARD_STRINGS.NAME; // 读取本地化的名字
    private static final String IMG_PATH = "FrierenModResources/img/cards/DoubleMagicInDrawPile_skill.png";
