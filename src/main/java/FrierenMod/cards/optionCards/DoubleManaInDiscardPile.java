...
public class DoubleManaInDiscardPile extends AbstractBaseCard {
    public static final String ID = ModInformation.makeID(DoubleManaInDiscardPile.class.getSimpleName());
    ...
    public DoubleManaInDiscardPile() {
        super(info);
